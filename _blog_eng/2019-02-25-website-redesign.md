...
<div class="uk-child-width-1-3 uk-child-width-1-6@s" uk-grid uk-lightbox="animation: fade">
    {% include image.html url="/images/blog/website-redesign/illu1.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/illu2.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/illu3.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/illu4.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/illu5.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/illu6.png" caption="
...
<div class="uk-child-width-1-3 uk-child-width-1-6@s" uk-grid uk-lightbox="animation: fade">
    {% include image.html url="/images/blog/website-redesign/ba1-old.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/ba1-new.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/ba2-old.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/ba2-new.png" caption="
    ...
    "%}
    {% include image.html url="/images/blog/website-redesign/ba3-old.png" caption="
        Our old FAQ was just a block of questions and answer. We wanted to make information easier to find.
    "%}
    {% include image.html url="/images/blog/website-redesign/ba3-new.png" caption="
